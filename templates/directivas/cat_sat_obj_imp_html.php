...
class cat_sat_obj_imp_html extends html_controler {
    ...
    public function inputs_cat_sat_obj_imp(controlador_cat_sat_obj_imp $controlador_nom_nomina): array|stdClass
    {
    ...
    public function input_exento(int $cols, stdClass $row_upd, bool $value_vacio): array|string
    {
        ...
        $html =$this->directivas->input_text(disable: false,name: 'exento',place_holder: 'Exento',
