...
class cat_sat_uso_cfdi extends modelo{
    ...
    public function alta_bd(): array|stdClass
    {
        ...
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al insertar uso CFDI', data: $r_alta_bd);
        }
        return $r_alta_bd;
    }
    ...
    public function modifica_bd(array $registro, int $id, bool $reactiva = false): array|stdClass
    {
        ...
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al modificar uso CFDI',data:  $r_modifica_bd);
        }
