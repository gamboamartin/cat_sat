...
class controlador_cat_sat_tipo_persona extends controlador_base {
                             ...
                             bool $aplica_form = true, bool $muestra_btn = true): array|string
    {
        ...
        $r_modifica = parent::modifica(false, false, $breadcrumbs, $aplica_form, $muestra_btn); // TODO: Change the autogenerated stub
        if(errores::$error){
            return $this->retorno_error(mensaje: 'Error al obtener template', data: $r_modifica,header:  $header, ws: $ws);
        }
